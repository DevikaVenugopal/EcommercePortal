...
<div class="fileinput fileinput-new" data provides="fileinput">
   ...
   <div id="update" class="tab-pane fade"><br><br>
     <a href="category?status=" class="btn btn-primary btn-block">Category List</a><br/>
     <a href="supplier?status=" class="btn btn-primary btn-block">Supplier List</a><br/>
     <a href="product?status=" class="btn btn-primary btn-block">Product List</a><br/>
  </div>
