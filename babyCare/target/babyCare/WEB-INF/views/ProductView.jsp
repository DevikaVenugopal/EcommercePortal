				...
				<div class="wrapper row">
					<div class="preview col-md-6">
						...
						<div class="preview-pic tab-content">
						  <div class="tab-pane active" id="pic-1"><img src="${pageContext.request.contextPath}/resources/images/${product.productId}.jpg" /></div>
					...
					<div class="details col-md-6">
						...
						<h5 class="price">Available Stock : <span>${product.stock}</span></h5>
